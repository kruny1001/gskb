...
class Genesets(models.Model):
    ...
    genes = models.TextField("Genes", blank=True)
    genessym = models.TextField("Genes Symbolic", db_column='genesSym', blank=True) # Field name made lowercase.
    class Meta:
        db_table = u'genesets'
...
class GenesetsTable(django_tables2.Table):
    class Meta:
        model = Genesets
